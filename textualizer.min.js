...
n(b,j){function A(a){var b,c,g,h={};if(j.getComputedStyle)if(a=j.getComputedStyle(a,null),a.length){c=0;for(g=a.length;c<g;c++)b=a[c].replace(/\-([a-z])/,function(a,b){return b.toUpperCase()}),h[b]=a.getPropertyValue(a[c])}else for(b in a)"function"!==typeof a[b]&&"length"!==b&&(h[b]=a[b]);else for(b in a=a.currentStyle||a.style,a)Object.prototype.hasOwnProperty.call(a,b)&&(h[b]=a[b]);return h}function C(){this.pos=this.domNode=this.character=null;this.visited=this.inserted=this.used=!1}function v(){this.str=
